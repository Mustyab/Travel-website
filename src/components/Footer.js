  ...
  return (
    <div className='footer-container'>
      <section className='footer-subscription-heading'>
        <p className='footer-subscribtion-heading'>Join the adventure newsletter to recieve our best vacation deals</p>
